...
function calcBuyRent()
{
    ...
    {
        advice_text.innerText = 'Since you expect to stay at the property for ' + num_years_expected + ' years, then buying a home might be a better option.';
    }
    else
    {
        advice_text.innerText = 'Since you expect to stay at the property for less than ' + breakeven_year + ' years, then renting might be a better option.';
    }
}